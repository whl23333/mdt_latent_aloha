...
class LatentActionAnalyzer:
    ...
    def visualize_coefficient_heatmap(self):
        ...
        ax.set_yticklabels(self.action_dims)
        ax.set_xlabel('Embedding Dimension (256)', fontsize=12)
        ax.set_ylabel('Action Dimension', fontsize=12)
        ax.set_title('Linear Regression Coefficient Matrix (256 → 7)', fontsize=14, fontweight='bold')
